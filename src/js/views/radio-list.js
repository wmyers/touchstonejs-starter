		...
		return (
			<UI.View>
				<UI.Headerbar type="default" label="Favourite Icecream">
					<Link to="details" viewTransition="reveal-from-right" className="Headerbar-button ion-chevron-left" component="button" viewProps={{ user: this.props.user, flavour: this.state.flavour }}>Details</Link>
